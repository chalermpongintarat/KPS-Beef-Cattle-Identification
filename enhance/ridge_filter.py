...
# RIDGEFILTER - Enhances muzzle print image via oriented filters.

# Function to enhance muzzle print image via oriented filters

# Usage:	newim = ridgefilter(im, orientim, freqim, kx, ky, showfilter)
...
#							  largest scale filter is displyed for inspection.
